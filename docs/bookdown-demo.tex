...
\addcontentsline{toc}{subsection}{Tags}
...
\includegraphics{_book/assets/css_example.png}
...
\addcontentsline{toc}{subsection}{Common properties}
...
\addcontentsline{toc}{subsection}{Box Model}
...
\includegraphics{_book/assets/box-model.png}
...
\includegraphics{_book/assets/ta-website.png}
...
\includegraphics{_book/assets/console.png}

\hypertarget{code-samples}{%
\subsection*{Code samples}\label{code-samples}}
\addcontentsline{toc}{subsection}{Code samples}
...
\addcontentsline{toc}{subsection}{The DOM}
...
\addcontentsline{toc}{subsection}{How do we get the data?}
...
\addcontentsline{toc}{subsection}{1. Search Bar and Button}
...
\addcontentsline{toc}{subsection}{2. API Call}
...
\addcontentsline{toc}{subsection}{3. City Information}
...
\addcontentsline{toc}{subsection}{4. Forecast Information}
...
\addcontentsline{toc}{subsection}{04.05.2022 - Web-Dev Coding Introduction}
...
\addcontentsline{toc}{subsection}{18.05.2022 - 1. Coding Meetup}

\hypertarget{udemy-course}{%
\subsubsection*{Udemy Course}\label{udemy-course}}
\addcontentsline{toc}{subsubsection}{Udemy Course}
...
\addcontentsline{toc}{subsection}{01.06.2022 - 2. Coding Meetup}
...
\addcontentsline{toc}{subsection}{15.06.2022 - 3. Coding Meetup}
...
\addcontentsline{toc}{subsection}{29.06.2022 - 4. Coding Meetup}
...
\includegraphics{_book/assets/font-awesome.png}
